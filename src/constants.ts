...
export const storageEquipment: Equipment[] = [
  {
    ...
    cfm: 35,
    heatGeneration: 410,
    description: '1Uネットワークストレージ。RAID対応、iSCSI/NFS/CIFS対応。中小規模向けファイルサーバー。',
    specifications: {
      capacity: '最大8TB（2.5インチ×4台）',
      raid: 'RAID 0/1/5/6/10対応',
      network: 'Gigabit×2, 10GbE対応',
      protocols: 'iSCSI/NFS/CIFS/FTP',
      management: 'Web管理画面'
    },
    mountingNotes: 'スライドレール必須。前面アクセス要確保。',
    mountingMethod: 'rails',
  ...
  },
  {
    ...
    cfm: 70,
    heatGeneration: 853,
    description: '2U高容量ネットワークストレージ。大容量RAID対応、高速ネットワーク対応。大規模向けファイルサーバー。',
    specifications: {
      capacity: '最大96TB（3.5インチ×12台）',
      raid: 'RAID 0/1/5/6/10/50/60対応',
      network: 'Gigabit×4, 10GbE×2対応',
      protocols: 'iSCSI/NFS/CIFS/FTP/S3',
  ...
  },
  {
    ...
    cfm: 55,
    heatGeneration: 614,
    description: '2Uテープライブラリ。LTO-9対応。自動バックアップシステム。長期保存とアーカイブ用。',
    specifications: {
      capacity: 'LTO-9×24本（432TB）',
      interface: 'SAS-3/FC-16G対応',
  ...
  },
  {
    ...
    cfm: 110,
    heatGeneration: 1195,
    description: '4U大容量テープライブラリ。LTO-9対応。エンタープライズ向け自動バックアップシステム。',
    specifications: {
...
export const otherEquipment: Equipment[] = [
  ...
  },
  {
    ...
    cfm: 0,
    heatGeneration: 0,
    description: '1Uパッチパネル。Cat6A対応。構造化配線システムの中継点として使用。',
    specifications: {
      category: 'Cat6A対応（10Gbps）',
      connector: '110パンチダウン端子',
      material: 'スチール製（粉体塗装）',
      mounting: 'ゲージナット + M6ネジ固定',
      compliance: 'TIA/EIA-568準拠'
    },
    mountingNotes: 'ゲージナット専用。背面アクセス要確保。ケーブル管理スペース必要。',
    mountingMethod: 'cage-nuts',
    requiresRails: false,
    requiresCageNuts: true
  },
  {
    ...
    cfm: 0,
    heatGeneration: 0,
    description: '2U高密度パッチパネル。Cat6A対応。データセンター向け実装。モジュラー設計。',
    specifications: {
      category: 'Cat6A対応（10Gbps）',
      connector: '110パンチダウン端子',
      material: 'スチール製（粉体塗装）',
      mounting: 'ゲージナット + M6ネジ固定',
      compliance: 'TIA/EIA-568準拠',
      modules: '取り外し可能モジュール×4個'
    },
    mountingNotes: 'ゲージナット専用。重量のため2人作業推奨。十分な背面スペース確保必要。専用ケーブル管理推奨。',
    mountingMethod: 'cage-nuts',
    requiresRails: false,
    requiresCageNuts: true
  },
  {
    id: 'patch-panel-2u-fiber',
    name: 'ファイバーパッチパネル (2U)',
    height: 2,
    depth: 200,
    power: 0,
    ...
    cfm: 0,
    heatGeneration: 0,
    description: '2U光ファイバーパッチパネル。LC/SC/ST/MPO対応。シングルモード・マルチモード両対応。データセンター間接続用。',
    specifications: {
      fiberType: 'シングルモード・マルチモード対応',
      connector: 'LC/SC/ST/MPO対応',
      material: 'スチール製（粉体塗装）',
      mounting: 'ゲージナット + M6ネジ固定',
      compliance: 'TIA/EIA-568準拠',
      accessories: 'ファイバー管理トレイ×2個'
    },
    mountingNotes: 'ゲージナット専用。光ファイバー取り扱い注意。曲げ半径厳守。専用工具必要。',
    mountingMethod: 'cage-nuts',
    requiresRails: false,
    requiresCageNuts: true
  },
